      ...
      <header>
        <nav>
          ...
          <ul>
            ...
            <li className="Checkout"><Link to="/Checkout">.</Link></li>
            <li className="seatSelection"><Link to="/seatSelection">Concerts</Link></li>
            <li className="signup"><Link to="/SigninSide">Sign Up</Link></li>
            <li className="Feedback"><Link to="/Feedback">FeedBack</Link></li>
